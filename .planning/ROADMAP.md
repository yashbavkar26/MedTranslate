...
|---|-------|------|--------------|---------|
| 1 | Backend Safety Foundation | Establish the shared API, Ollama adapter, structured response contract, and medical safety guardrails | API-01, LLM-01, LLM-02, LLM-03, SAFE-01, SAFE-02 | no |
